        ...
        internal void Defier(Personnage adversaire, int coup)
        {
            if (coup == 1) // si le joueur a choisi de répliquer par un coup de pied
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Vous attaquez " + adversaire._nom + " qui perd 25 points de vie. Il lui reste " +
            ...
            if (coup == 2) // si le joueur a choisi de répliquer par un coup de poing
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Vous attaquez " + adversaire._nom + " qui perd 15 points de vie. Il lui reste " +
                    adversaire._ptVie + " points de vie.");
                }
            }
        }
