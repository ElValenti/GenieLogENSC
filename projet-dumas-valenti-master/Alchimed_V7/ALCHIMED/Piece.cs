...
namespace ALCHIMED
{
    // création d'une énumération pour faciliter 
    //l'évaluation de l'entrée dans une Pièce 
    // via la méthode Acceder de la classe Piece
    public enum Acces
    {
        Autorise,
        RefuseEtude,
    ...
    class Piece
    {
        ...
        protected int _nbGet;
        protected int _nbSet;
        ...
        //méthode qui renvoie true si la pièce actuelle 
        //est le laboratoire
        ...
        // pour choisir de dévoiler ou non le contenu d'une pièce dans la méthode Déplacer de la classe Joueur
        ...
        public void AttribuerSavoir()
        {
                ...
                for (int i = 0; i < 3; i++)
                {
                    //tant que l'objet choisi au hasard possède déjà un savoir,
                    //on en tire un autre au hasard
                    do
                    { 
        ...
        // Affiche toutes les interactions possibles dans la pièce
        public void Lister()
        {
