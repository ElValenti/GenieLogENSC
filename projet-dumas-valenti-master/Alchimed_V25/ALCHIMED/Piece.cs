    ...
    class Piece
    {
        ...
        internal void Lister()
        {
            ...
            foreach (Objet objet in _objets)
            {
                compteur++;
                objet.Num = compteur;
                Console.WriteLine(objet.Num + " : " + objet.Nom);
            }
            Console.ResetColor();
        }
        ...
        public override string ToString()
        {
            ...
            {
                Console.WriteLine("\n\nVous vous apprêtez à entrer dans le grand Laboratoire... Comme vous le savez,\nvous devez synthétiser un médicament " +
                    "de composition complexe mais ce n’est pas\ntout ! Vous devez à tout prix réaliser le BON médicament. N’oubliez pas cela,\n" +
                    "car une fois que vous serez entré dans le laboratoire, vous serez plongé dans uncontexte de crise, mis sous pression, votre " +
                    "stress va monter, alors gardez votresang froid, prenez le temps de réfléchir, n’agissez pas au hasard et soyez\nprudent, car votre avenir en dépend...");
                Console.ReadKey();
                Console.Clear();

                ch = ("Vous êtes prêt, vous posez votre main sur la poignée, l'actionnez...\nDans un grincement, la porte s’ouvre, sur une pièce immaculée " +
                    "et froide. Soudainune alarme se déclenche, plusieurs néons explosent. Dans un nuage de poussière,\nle décor change. Tout " +
                    "semble vaciller autour de vous...\n\nLorsque la visibilité revient, vous cherchez des repères indiquant qu’il s’agit\nbien du " +
                    "grand Laboratoire d’Alchimed, vous cherchez des éléments d’explication àce qu’il vient de se passer. En vain. La pièce où vous " +
                    "êtes n’a rien d’un grand\nlaboratoire de recherche, elle évoque plutôt un laboratoire improvisé suite à unsinistre...");
                ch += ("\n\nUn homme s'adresse à vous...\nFélicitations, si vous êtes ici c’est que vous êtes suffisamment compétent pour que l’on" +
                    " vous explique ce qu’il se passe. Très peu de personnes sont au courant,mais le gouvernement a mis en place une cellule de " +
                    "crise pour gérer la pandémie\nà venir. Ce laboratoire est le lieu d’expérimentation pour trouver un\nmédicament. Je dois" +
                    " cependant vous prévenir que vous n’êtes pas le premier\ncandidat à essayer... Vos prédécesseurs ne n’en sont pas sortis " +
                    "indemnes...\n\nAutour de vous, vous voyez ");
            }
