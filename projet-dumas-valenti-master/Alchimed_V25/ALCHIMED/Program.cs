    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Guide milou = new Guide("Milou", 1000, new List<string>() { "Vous devez mélanger trois substances pour obtenir ce médicament... hmm je vois... du phytoménadione...",
                ...
                Potion p1 = new Potion("le galafène", "a un effet connu", Effets.p_galactumerie, new List<Substances>() { Substances.nalidixique,
                    Substances.dimercaprol, Substances.phytoménadione } );
                Potion p2 = new Potion("le fitopane", "a un effet connu", Effets.p_fitoparose, new List<Substances>() { Substances.sulfaméthizol,
                    Substances.glipizide, Substances.nitrofurantoïne });
                Potion p3 = new Potion("le tamilion", "a un effet connu", Effets.p_stress, new List<Substances>() { Substances.noramidopyrine,
                    Substances.rasburicase, Substances.sulfacétamide });
                potions = new List<Potion> { p1, p2, p3 };
